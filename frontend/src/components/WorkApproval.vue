...
<!--                <input class="form-control" type="text" />-->
          ...
          <div class="d-flex flex-row justify-content-evenly mb-3">
            <button class="btn btn-primary" type="button" @click="approve">Godkjenn</button>
            <button class="btn btn-primary" type="button" @click="remove">Slett</button>
            <button class="btn btn-primary" type="button" @click="cancel">Avbryt</button>
          </div>
        </form>
      </div>
    </div>
...
export default {
  ...
  methods: {
    approve() {
      let url = "http://localhost:8080/queue/" + this.courseId + "/" + this.student_id + "/update"
